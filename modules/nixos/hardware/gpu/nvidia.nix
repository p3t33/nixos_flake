...
let
  cfg = config.customOptions.enableModule.nvidia;
in
{
  options.customOptions.enableModule.nvidia = lib.mkEnableOption "Enable NVIDIA proprietary driver configuration";
