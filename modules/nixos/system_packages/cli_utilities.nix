...
let
  cfg = config.customOptions.enableModule.cliUtilities;
in
{
  options.customOptions.enableModule.cliUtilities = lib.mkEnableOption "Enable general tools, utilities, and media/networking programs";
