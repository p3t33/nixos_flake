...
let
  cfg = config.customOptions.enableModule.printer;
in
{
  options.customOptions.enableModule.printer = lib.mkEnableOption "Enable CUPS printing system and required printer drivers";
