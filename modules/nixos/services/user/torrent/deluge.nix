...
let
  cfg = config.customOptions.enableModule.deluge;
in
{
  options.customOptions.enableModule.deluge = lib.mkEnableOption "Enable Deluge torrent client with declarative configuration";
