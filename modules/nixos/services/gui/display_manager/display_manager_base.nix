...
let
  cfg = config.custom.services.displayManager;
in
{
  options.custom.services.displayManager.enable = lib.mkEnableOption "Enable displayManager with auto login and i3 session";
