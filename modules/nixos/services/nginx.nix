...
let
  cfg = config.customOptions.enableModule.nginx;
...
in
{
  options.customOptions.enableModule.nginx = lib.mkEnableOption "Enable Nginx reverse proxy server for all internal services";
