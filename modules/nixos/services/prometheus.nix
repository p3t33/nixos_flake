...
let
  cfg = config.customOptions.enableModule."prometheus";
in
{
  options.customOptions.enableModule."prometheus" = lib.mkEnableOption "Enable Prometheus monitoring and exporters";
