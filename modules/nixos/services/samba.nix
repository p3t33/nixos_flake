...
let
  cfg = config.customOptions.enableModule.samba;
in
{
  options.customOptions.enableModule.samba = lib.mkEnableOption "Enable Samba service for sharing torrents folder with authentication";
