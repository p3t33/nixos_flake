...
let
  cfg = config.customOptions.enableModule.moolticuted;
in
{
  options.customOptions.enableModule.moolticuted = lib.mkEnableOption "Enable the Moolticuted systemd service and udev rules";
