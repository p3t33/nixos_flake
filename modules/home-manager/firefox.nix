{config, pkgs, ...}:
{
    programs.firefox = {
        ...
        policies = {
            ...
            # copy the uuid and uninstal the plugin.
            #
            # to get the shortId value you will need to do some trial and error and see that the url is valild and when used from
            # firefox url it will trigger installtion.
