...
let
  # 12 hours in seconds
  timeout = 43200;
  cfg = config.customOptions.enableModule.gpgAgent;
in
{

  options.customOptions.enableModule.gpgAgent = lib.mkEnableOption "Enable GPG and GPG agent with SSH support and custom TTL settings";
